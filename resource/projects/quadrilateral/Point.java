...
public class Point {
  ...
  /**
   * This method uses the distance formula to find the distance between two
   * points
   *
  ...
  /**
   * This method creates a new Point representing the midpoint between two
   * points
   *
   * @param p the second point
   ...
   */
  public double slope(Point p) { return (p.y - y) / (p.x - x); }
  ...
  /**
   * This method checks if any two given double values are within a set
   * precision value
   *
   * @param a first value
  ...
  public Point reflectYEqualsX() { return new Point(y, x); }
