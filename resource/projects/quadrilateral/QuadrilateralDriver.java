...
public class QuadrilateralDriver {
  public static void main(String[] args) throws Exception {
    ...
    do {
      ...
      System.out.println(
          "Enter Top Left Point (1) in the following format:\nx y");
      double x = sc.nextDouble();
      pointList[0] = new Point(x, sc.nextDouble());
      System.out.println(
          "Enter Top Right Point (2) in the following format:\nx y");
      x = sc.nextDouble();
      pointList[1] = new Point(x, sc.nextDouble());
      System.out.println(
          "Enter Bottom Right Point (3) in the following format:\nx y");
      x = sc.nextDouble();
      pointList[2] = new Point(x, sc.nextDouble());
      System.out.println(
          "Enter Bottom Left Point (4) in the following format:\nx y");
      x = sc.nextDouble();
      ...
      Quadrilateral ql = new Quadrilateral(pointList[0], pointList[1],
                                           pointList[2], pointList[3]);
      System.out.println(ql.toString());
      System.out.println("IS TRAPEZOID: " + (ql.isTrapezoid() ? "YES" : "NO"));
      System.out.println("IS PARALLELOGRAM: " +
                         (ql.isParallelogram() ? "YES" : "NO"));
