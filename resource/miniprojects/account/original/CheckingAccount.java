...
public class CheckingAccount extends Account {
  ...
  // Constructs a CheckingAccount with given owner and starting check number,
  // with an initial balance of zero, by calling THIS class' other constructor
  // method.
  ...
  // (this is in lieu of printing an actual check), and return true.
