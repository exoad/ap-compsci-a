...
public class RPSLSArena
{
  public static void main(String[] args)
  {
    ...
    //schedule tournament
    RPSLSStrategy[] players = {new CopyBot(), new CycleBot(), new SheldonCooperBot(), new RockBotTom(),
                               new Botzilla(), new OrigamiBot(), new EdwardScissorBot(), new RandoCalrissian()};
