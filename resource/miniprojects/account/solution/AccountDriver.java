...
public class AccountDriver {
    public static void main(String[] args) {
        ...
        /*
         * Answer: The instanceof checks if the mentioned object, in this case: acctList
         * sub i is checking if it is an instance of class SavingsAccount
         * 
         * In general it allows for the access of the child class
         * 
         * If it is, it would return true running the code of compoundInterest, or using
         * the derived class's methods, but does not follow standard inheritance rules.
